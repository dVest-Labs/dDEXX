...
var Icon$eth = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("path", { d: "M16 32C7.163 32 0 24.837 0 16S7.163 0 16 0s16 7.163 16 16s-7.163 16-16 16zm7.994-15.781L16.498 4L9 16.22l7.498 4.353l7.496-4.354zM24 17.616l-7.502 4.351L9 17.617l7.498 10.378L24 17.616z" })));
};

var Icon$bsc = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 2000 2000" }, props),
        React.createElement("path", { d: "M611.59 840.42l388.4-388.39 388.6 388.59 226-226L999.99 0 385.6 614.42l225.99 226M.006 999.969l226.007-226.007 225.992 225.993L226 1225.96zM611.59 1159.58l388.4 388.39 388.59-388.58 226.12 225.88-.11.12L999.99 2000l-614.41-614.4-.32-.32 226.33-225.7M1548.013 1000.093l226.007-226.006 225.992 225.992-226.006 226.007z" })));
};
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://telegram.me/defivest",
        // items: [
        //     {
        //         label: "English",
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/dvestproject",
    },
    {
        label: "Discord",
        icon: "DiscordIcon",
        href: "https://discord.gg/zypXRbUBpw",
    }
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { color_balck:"24262e",color_blue:"#24262e",primaryblack:"#24262e",textblack:"#ccc",orange_color:"#f3841e",orangetext_subhead:"#333",dash_heading:"#333",background: "#f9f9f9", textblack:"#333", backgroundDisabled: "#e9eaeb", contrast: "#333", invertedContrast: "#FFFFFF", input: "#e9eaeb", inputSecondary: "#e9eaeb", tertiary: "#f1f1f1", text: "#24262e", textDisabled: "#bdc2c4", textSubtle: "#00d2d4", borderColor: "#E9EAEB", card: "#fff",  card_small: "#333", gradients: {
    bubblegum: "linear-gradient(139.73deg, #fff 0%, #fff 100%)",
} });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { color_balck:"fff",color_blue:"#fff",primaryblack:"#fff",textblack:"#fff",orange_color:"#f3841e", orangetext_subhead:"#fff",dash_heading:"#fff",secondary: "#fff", textblack:"#fff", background: "#1a1c21", backgroundDisabled: "#208283", contrast: "#FFFFFF", invertedContrast: "#18181c", input: "#18181c", inputSecondary: "#18181c", primaryDark: "#0098A1", tertiary: "#1a1c21", text: "#fff", textDisabled: "#ccc",  card_small: "#fff",textSubtle: "#fff", borderColor: "#524B63", card: "#24262e", new: "#ffffff", gradients: {
