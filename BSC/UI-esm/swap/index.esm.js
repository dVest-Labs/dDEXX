...
var Icon$Z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: '/images/logo_icon.png' })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { textwhitebl:"#1a1c21",textwhite:"#fff",color_balck:"24262e",color_blue:"#24262e",primaryblack:"#24262e",textblack:"#ccc",orange_color:"#f3841e",orangetext_subhead:"#333",dash_heading:"#333",background: "#f9f9f9", textblack:"#333", backgroundDisabled: "#e9eaeb", contrast: "#333", invertedContrast: "#FFFFFF", input: "#e9eaeb", inputSecondary: "#e9eaeb", tertiary: "#f1f1ff1", text: "#24262e", textDisabled: "#bdc2c4", textSubtle: "#00d2d4", borderColor: "#E9EAEB", card: "#fff",  card_small: "#333", gradients: {
    bubblegum: "linear-gradient(139.73deg, #fff 0%, #fff 100%)",
} });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { textwhitebl:"#fff",textwhite:"#fff",color_balck:"fff",color_blue:"#fff",primaryblack:"#fff",textblack:"#fff",orange_color:"#f3841e", orangetext_subhead:"#fff",dash_heading:"#fff",secondary: "#fff", textblack:"#fff", background: "#1a1c21", backgroundDisabled: "#208283", contrast: "#FFFFFF", invertedContrast: "#24262e", input: "#18181c", inputSecondary: "#18181c", primaryDark: "#0098A1", tertiary: "#1a1c21", text: "#fff", textDisabled: "#ccc",  card_small: "#fff",textSubtle: "#fff", borderColor: "#524B63", card: "#24262e", new: "#ffffff", gradients: {
