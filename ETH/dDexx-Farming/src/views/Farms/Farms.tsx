...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="color_blue" mb="50px" style={{ textAlign: 'center' }}>
        {
          tokenMode ?
            TranslateString(10002, 'Stake tokens to earn dDEXX')
            :
          TranslateString(320, 'Stake LP tokens to earn dDEXX')
        }
      </Heading>
