...
const CardActions: React.FC<FarmCardActionsProps> = ({ farm, ethereum, account }) => {
  ...
  const renderApprovalOrStakeButton = () => {
    return isApproved ? (
      <StakeAction stakedBalance={stakedBalance} tokenBalance={tokenBalance} tokenName={lpName} pid={pid} depositFeeBP={depositFeeBP} tokenDecimal={tokenDecimal} />
    ) : (
  ...
  return (
    <Action>
      ...
      <HarvestAction earnings={earnings} pid={pid} decimal={tokenDecimal}/>
      <Flex>
        <Text bold textTransform="uppercase" color="secondary" fontSize="12px" pr="3px">
          {lpName}
        </Text>
